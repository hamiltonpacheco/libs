            ...
            stage('Build and publish image to ECR Staging') {
              ...
              container('node') {
                withEnv(homologEnvList) {
                  sh 'npm run build'
                  // veracode applicationName: 'testeveracode', 
                  //   canFailJob: false, 
                  //   createProfile: true, 
                  //   createSandbox: true, 
                  ...
                  //   fileNamePattern: '', 
                  //   replacementPattern: '', 
                  //   sandboxName: 'testeveracode', 
                  //   scanExcludesPattern: '', 
                  //   scanIncludesPattern: '', 
                  //   scanName: 'testeveracode', 
                  //   teams: '', 
                  //   timeout: 120, 
                  //   uploadExcludesPattern: '', 
                  //   uploadIncludesPattern: '**/**.js', 
                  //   vid: '', 
                  //   vkey: '', 
                  //   vpassword: 'q$2>yQ#^r&lo', 
                  //   vuser: 'prevendas+nexadigital@m3corp.com.br', 
                  //   waitForScan: true
                }
              }
              container('docker') {
             ...
             //Container Image Scanner
                ...
                docker save ${awsStagingImageName} -o ${registryRepository}/${tag}.tar && \
                apk add curl git && \
                ...
                docker tag ${awsStagingImageName} ${REGISTRY_CONFIG.host}/${awsStagingImageName} && \
                docker push ${REGISTRY_CONFIG.host}/${awsStagingImageName}
                """
                }
              }
            }
